...
Aerodrome Traffic Zones (ATZ) are established within the Class F airspace around [Goroka (AYGA)](Goroka.md) , [Madang (AYMD)](Madang.md), [Mount Hagen (AYMH)](Mt-Hagen.md), and [Tokua (AYTK)](Tokua.md). ATZs extend vertically from `SFC`-`A200` can extend laterally between 15nm and 25nm from the ARP, depending on the aerodrome.
...
!!! phraseology
    ...
    **ABC***: "Copy traffic, Taxi to holding point D, runway 25, ABC."
	* _later_ *
    **ABC**: "ABC, Ready."  
...
!!! phraseology
    ...
    **LMN***: "Report overhead YGASG, LMN."
    	* _later_ *
     **LMN**: "Currently overhead YGASG, LMN."
