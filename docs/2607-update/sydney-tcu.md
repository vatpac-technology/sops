...
Hidden because breaks on coming soon branch
### YSSY Calculator
...
##### Arrivals
IFR arrivals will be cleared direct to the IAF and handed to SBA assigned `A030`. [Heads-up coordination](../../controller-skills/coordination/#heads-up) is required for these aircraft.
...
SY TCU will instruct aircraft to leave controlled airspace via the approach and will transfer aircraft to **CN ADC** prior to `SC2WI`.  **CN ADC** shall issue airways clearance on first contact in accordance with the table below.  
