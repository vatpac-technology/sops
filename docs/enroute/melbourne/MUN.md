...
<figure markdown>
![Mungo Airspace](../img/enr_diagrams/mun.png){ width="700" }
...
When splitting the stream inbound to ARBEY between RWY 27 and RWY 34, controllers should consider rerouting aircraft for RWY 34 via the **ALAXO STAR**. Aircraft for RWY 27 should be cleared the **ARBEY STAR**. This provides lateral separation assurance in the TMA.

If a stream of aircraft is inbound via ALAXO, controllers should coordinate with the TCU to establish a vertical or lateral separation technique.
