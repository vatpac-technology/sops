...
Many pilots flying obscure callsigns will notate their callsign in their flight plan remarks (for example, *"RTF/CALLSIGN (callsign)"* ). For any callsign that is not immediately obvious, controllers should check the remarks for guidance and, if necessary, put the callsign in the remarks to assist future controllers.
