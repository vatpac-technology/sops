...
When MAESTRO is in use and an aircraft is departing for YMML, **EN SMC** (or **EN ADC** if SMC is not online) shall advise **MFL** when the aircraft commences taxi. MFL will activate the flight in MAESTRO and advise a landing time.
